...
const events = [
    ...
    { 
        ...
        details: "The explosive rhetoric from Suharto's New Order enabled him to use the populace as a tool to maintain deniability as left-of-center Indonesians were detained and massacred en masse. By the end of the killings, some half a million to a milllion people were killed, and between 600,000-750,000 detained for varying lengths of time up to the late 1970's. Much of the violence was conducted by Muslim political groups, such as the Ansor Youth Group. Ethnicity also played a large role in the violence, with many Chinese-Indonesian citizens being murdered, especially in Medan, Makassar, and Lombok.",
